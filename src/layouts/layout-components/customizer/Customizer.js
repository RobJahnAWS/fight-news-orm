                    ...
                    <div className="mt-3 border-bottom px-3">
                        ...
                        >
                            <label
                                className={
                                    "btn btn-outline-secondary " +
                                    (settings.activeSidebarPos === "fixed"
                                        ? "active"
                                        : "")
                                }
                            >
                            ...
                            <label
                                className={
                                    "btn btn-outline-secondary " +
                                    (settings.activeSidebarPos === "absolute"
                                        ? "active"
                                        : "")
                                }
                            >
                                <input
                                    ...
                                    id="sidebar-absolute"
                                    onClick={() =>
                                        dispatch(setSidebarPos("absolute"))
                                    }
                                />{" "}
                                Not Fixed
                            </label>
                    ...
                    <div className="mt-3 border-bottom px-3">
                        ...
                        >
                            <label
                                className={
                                    "btn btn-outline-secondary " +
                                    (settings.activeHeaderPos === "fixed"
                                        ? "active"
                                        : "")
                                }
                            >
                            ...
                            <label
                                className={
                                    "btn btn-outline-secondary " +
                                    (settings.activeHeaderPos === "absolute"
                                        ? "active"
                                        : "")
                                }
                            >
                                <input
                                    ...
                                    id="header-absolute"
                                    onClick={() =>
                                        dispatch(setHeaderPos("absolute"))
                                    }
                                />{" "}
                                Not Fixed
                            </label>
                    ...
                    <div className="mt-3 border-bottom px-3">
                        ...
                        >
                            <label
                                className={
                                    "btn btn-outline-secondary " +
                                    (settings.activeSidebarType === "full"
                                        ? "active"
                                        : "")
                                }
                            >
                            ...
                            <label
                                className={
                                    "btn btn-outline-secondary " +
                                    (settings.activeSidebarType === "iconbar"
                                        ? "active"
                                        : "")
                                }
                            >
